...
class ParseDirectoryUseCase:
    ...
    def subscribe(self, callback: Callable[[ParsingState], None]) -> None:
        """Allows observers to listen to state changes."""
        self._subscribers.append(callback)
        callback(self._state)

    def _emit(self, new_state: ParsingState) -> None:
        """Internal helper to transition state and notify subscribers."""
    ...
    def execute(self, directory_path: str) -> None:
        ...
        try:
            ...
            source_codes = self._repository.fetch_target_codes(directory_path)
